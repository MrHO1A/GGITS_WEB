        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="messages">
                    <a href="http://ggits.org/showpage.php?mainid=10&subid=70&menu=submain" class="dropdown-item">Er. D.C Jain</a>
                    <a href="http://ggits.org/showpage.php?mainid=10&subid=72&menu=submain" class="dropdown-item">Mr. Rajneet Jain</a>
                    <a href="http://ggits.org/showpage.php?mainid=10&subid=73&menu=submain" class="dropdown-item">Mr. Pankaj Goyal</a>
                    <a href="http://ggits.org/showpage.php?mainid=10&subid=90&menu=submain" class="dropdown-item">Mr. Apurva Singhai</a>
                    <a href="http://ggits.org/showpage.php?mainid=10&subid=222&menu=submain" class="dropdown-item">Dr. Maneesh Choubey</a>
                    <a href="http://ggits.org/showpage.php?mainid=10&subid=225&menu=submain" class="dropdown-item">Dr. Vinod Kapse</a>
                </div>
            </li>
            <li class="nav-item dropdown">
